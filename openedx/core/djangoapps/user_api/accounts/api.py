...
from student.models import User, UserProfile, Registration, username_or_email_exists_or_retired
...
def _validate_email_doesnt_exist(email):
    ...
    """
    if email is not None and username_or_email_exists_or_retired(email):
